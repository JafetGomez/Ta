...
<Persona valorDocumento="10000002" nombre="Jos� Rodr�guez" email="p02@ejemplo.org" telefono="8002-0002"/>
<Persona valorDocumento="10000003" nombre="Andrea Vargas" email="p03@ejemplo.org" telefono="8003-0003"/>
<Persona valorDocumento="10000004" nombre="Daniel M�ndez" email="p04@ejemplo.org" telefono="8004-0004"/>
<Persona valorDocumento="10000005" nombre="Mar�a S�nchez" email="p05@ejemplo.org" telefono="8005-0005"/>
<Persona valorDocumento="10000006" nombre="Luis Araya" email="p06@ejemplo.org" telefono="8006-0006"/>
<Persona valorDocumento="10000007" nombre="Sof�a Morales" email="p07@ejemplo.org" telefono="8007-0007"/>
<Persona valorDocumento="10000008" nombre="Alejandro Navarro" email="p08@ejemplo.org" telefono="8008-0008"/>
<Persona valorDocumento="10000009" nombre="Carolina P�rez" email="p09@ejemplo.org" telefono="8009-0009"/>
...
<Persona valorDocumento="10000012" nombre="Gabriel Hern�ndez" email="p12@ejemplo.org" telefono="8012-0012"/>
<Persona valorDocumento="10000013" nombre="Paola Rojas" email="p13@ejemplo.org" telefono="8013-0013"/>
<Persona valorDocumento="10000014" nombre="Esteban Calder�n" email="p14@ejemplo.org" telefono="8014-0014"/>
<Persona valorDocumento="10000015" nombre="Laura Jim�nez" email="p15@ejemplo.org" telefono="8015-0015"/>
<Persona valorDocumento="10000016" nombre="Kevin L�pez" email="p16@ejemplo.org" telefono="8016-0016"/>
...
<Persona valorDocumento="10000021" nombre="Karina Guti�rrez" email="p21@ejemplo.org" telefono="8021-0021"/>
...
<Persona valorDocumento="10000025" nombre="Ximena S�nchez" email="p25@ejemplo.org" telefono="8025-0025"/>
...
<Persona valorDocumento="10000028" nombre="Sebasti�n Madriz" email="p28@ejemplo.org" telefono="8028-0028"/>
<Persona valorDocumento="10000029" nombre="Pamela Hidalgo" email="p29@ejemplo.org" telefono="8029-0029"/>
<Persona valorDocumento="10000030" nombre="Fabi�n Arias" email="p30@ejemplo.org" telefono="8030-0030"/>
...
<Persona valorDocumento="10000034" nombre="Jorge Mar�n" email="p34@ejemplo.org" telefono="8034-0034"/>
...
<Persona valorDocumento="10000040" nombre="H�ctor Ram�rez" email="p40@ejemplo.org" telefono="8040-0040"/>
<Persona valorDocumento="10000041" nombre="Roc�o Jim�nez" email="p41@ejemplo.org" telefono="8041-0041"/>
<Persona valorDocumento="10000042" nombre="Allan Z��iga" email="p42@ejemplo.org" telefono="8042-0042"/>
...
<Persona valorDocumento="10000046" nombre="�scar Alp�zar" email="p46@ejemplo.org" telefono="8046-0046"/>
<Persona valorDocumento="10000047" nombre="Karla Sol�s" email="p47@ejemplo.org" telefono="8047-0047"/>
<Persona valorDocumento="10000048" nombre="Randall C�spedes" email="p48@ejemplo.org" telefono="8048-0048"/>
<Persona valorDocumento="10000049" nombre="Fiorella G�mez" email="p49@ejemplo.org" telefono="8049-0049"/>
...
<Persona valorDocumento="10000052" nombre="Luc�a Delgado" email="p52@ejemplo.org" telefono="8052-0052"/>
<Persona valorDocumento="10000053" nombre="Leonardo Guzm�n" email="p53@ejemplo.org" telefono="8053-0053"/>
<Persona valorDocumento="10000054" nombre="Mariana Pineda" email="p54@ejemplo.org" telefono="8054-0054"/>
<Persona valorDocumento="10000055" nombre="Gerardo N��ez" email="p55@ejemplo.org" telefono="8055-0055"/>
<Persona valorDocumento="10000056" nombre="Patricia Aguilar" email="p56@ejemplo.org" telefono="8056-0056"/>
<Persona valorDocumento="10000057" nombre="Iv�n Gamboa" email="p57@ejemplo.org" telefono="8057-0057"/>
<Persona valorDocumento="10000058" nombre="M�nica C�spedes" email="p58@ejemplo.org" telefono="8058-0058"/>
<Persona valorDocumento="10000059" nombre="Andr�s Pineda" email="p59@ejemplo.org" telefono="8059-0059"/>
<Persona valorDocumento="10000060" nombre="Cinthya Vargas" email="p60@ejemplo.org" telefono="8060-0060"/>
<Persona valorDocumento="10000061" nombre="Ra�l Mora" email="p61@ejemplo.org" telefono="8061-0061"/>
<Persona valorDocumento="10000062" nombre="Melissa Ugalde" email="p62@ejemplo.org" telefono="8062-0062"/>
<Persona valorDocumento="10000063" nombre="V�ctor Porras" email="p63@ejemplo.org" telefono="8063-0063"/>
...
<Persona valorDocumento="10000068" nombre="Viviana Chac�n" email="p68@ejemplo.org" telefono="8068-0068"/>
<Persona valorDocumento="10000069" nombre="Ernesto Jim�nez" email="p69@ejemplo.org" telefono="8069-0069"/>
<Persona valorDocumento="10000070" nombre="Lorena Quesada" email="p70@ejemplo.org" telefono="8070-0070"/>
<Persona valorDocumento="10000071" nombre="Gustavo Le�n" email="p71@ejemplo.org" telefono="8071-0071"/>
</Personas>
<Propiedades>
...
<!--  Ac� empiezan las lecturas de Junio para pagar en Julio  -->
<LecturasMedidor>
...
<!--   por petici�n del profe se desasocian unos CC, se hace sobre la finca F-0001, se le quita consumo agua y el impuesto sobre propiedad   -->
<CCPropiedad>
...
<!--  LECTURAS ADELANTADAS: Para fincas que facturan los primeros d�as de Julio  -->
...
<!--  DEUDOR: F-0007 (Moroso Cr�nico) NO PAGA para iniciar morosidad.  -->
<Pagos>
...
<!--  PAGO ATRASADO: F-0013 paga su deuda de Junio (para probar c�lculo de intereses).  -->
...
<!--  NOTA: F-0007 (Moroso Cr�nico) sigue sin pagar  -->
<Pagos>
...
<!--  PAGO ATRASADO: F-0021 paga su deuda M�S ANTIGUA (Junio), Probar esta l�gica  -->
...
<!--  PAGO ATRASADO: F-0048 paga su segunda deuda m�s antigua (Julio)  -->
<!--  Al final de la simulaci�n, esta finca A�N tendr� deudas pendientes  -->
...
------------------------------------------------------------
-- DECLARACIÓN Y CARGA DE TABLA VARIABLE
------------------------------------------------------------
...
SELECT
      ROW_NUMBER() OVER (ORDER BY FX.N.value('@fecha', 'DATE')) AS Id
    , FX.N.value('@fecha', 'DATE') AS Fecha
FROM @XmlData.nodes('/Operaciones/FechaOperacion') AS FX(N);


------------------------------------------------------------
-- DECLARACIÓN DE TABLA VARIABLE @PagosAProcesar 
------------------------------------------------------------
DECLARE @PagosAProcesar TABLE (
...
DECLARE @Max                    INT;
DECLARE @Fecha                  DATE;
DECLARE @diasVencimientoFactura INT = 15;
DECLARE @outFactura             INT;
DECLARE @outCorte               INT;
-- Variables para el procesamiento de pagos
DECLARE @outSuccess             BIT;
DECLARE @outMessage             NVARCHAR(255);
DECLARE @outMontoPagado         MONEY;
DECLARE @outComprobanteCode     VARCHAR(64);
DECLARE @outPagoResultCode      INT;
-- Variables para la iteración de pagos
DECLARE @NumComprobantePago     INT;
DECLARE @NumFincaPago           VARCHAR(64);
DECLARE @MontoRecibidoPago      MONEY;
...
BEGIN
    ...
    BEGIN TRY
        ...
        PRINT '---------------------------------------------';
        PRINT 'Procesando fecha: ' + CONVERT(VARCHAR(20), @Fecha);
        PRINT '---------------------------------------------';
        ...
        SELECT
              P.N.value('@valorDocumento', 'INT') AS ValorDocumento
            , P.N.value('@nombre', 'VARCHAR(64)') AS Nombre
            , P.N.value('@email', 'VARCHAR(64)') AS Email
            , P.N.value('@telefono', 'VARCHAR(64)') AS Telefono
        FROM @XmlData.nodes(
                 '/Operaciones/FechaOperacion[@fecha=sql:variable("@Fecha")]/Personas/Persona'
               ) AS P(N);
        ...
        SELECT
              PR.N.value('@numeroFinca', 'VARCHAR(64)')
            , PR.N.value('@numeroMedidor', 'VARCHAR(64)')
            , PR.N.value('@metrosCuadrados', 'FLOAT')
            , PR.N.value('@valorFiscal', 'FLOAT')
            , PR.N.value('@tipoUsoId', 'INT')
            , PR.N.value('@tipoZonaId', 'INT')
            , PR.N.value('@fechaRegistro', 'DATE')
            , 0.0
            , 0.0
        FROM @XmlData.nodes(
                 '/Operaciones/FechaOperacion[@fecha=sql:variable("@Fecha")]/Propiedades/Propiedad'
               ) AS PR(N);
        ...
        SELECT
              'M-' + CAST(1000 + ROW_NUMBER() OVER (ORDER BY P.NumeroFinca) AS VARCHAR(10))
            , P.NumeroFinca
        FROM dbo.Propiedad AS P
        WHERE (
            NOT EXISTS (
                SELECT 1
                FROM dbo.Medidor AS M
                WHERE (M.NumeroFinca = P.NumeroFinca)
            )
        );


        ------------------------------------------------------------
        -- INSERTAR PROPIEDAD-PERSONA
        ------------------------------------------------------------
        ...
        SELECT
              PP.N.value('@valorDocumento', 'INT')
            , PP.N.value('@numeroFinca', 'VARCHAR(64)')
            , PP.N.value('@tipoAsociacionId', 'INT')
            , @Fecha
        FROM @XmlData.nodes(
                 '/Operaciones/FechaOperacion[@fecha=sql:variable("@Fecha")]/PropiedadPersona/Movimiento'
               ) AS PP(N);


        ------------------------------------------------------------
        -- INSERTAR CC-PROPIEDAD
        ------------------------------------------------------------
        ...
        SELECT
              CC.N.value('@numeroFinca', 'VARCHAR(64)')
            , CC.N.value('@idCC', 'INT')
            , CC.N.value('@tipoAsociacionId', 'INT')
        FROM @XmlData.nodes(
                 '/Operaciones/FechaOperacion[@fecha=sql:variable("@Fecha")]/CCPropiedad/Movimiento'
               ) AS CC(N);


        ------------------------------------------------------------
        -- INSERTAR LECTURAS Y ACTUALIZAR SALDO M3
        ------------------------------------------------------------
        ;WITH XMLLecturas AS (
            SELECT
                  L.N.value('@numeroMedidor', 'VARCHAR(64)') AS NumeroMedidor
                , L.N.value('@tipoMovimientoId', 'INT') AS idTipoMovimiento
                , L.N.value('@valor', 'FLOAT') AS Valor
            FROM @XmlData.nodes(
                    '/Operaciones/FechaOperacion[@fecha=sql:variable("@Fecha")]/LecturasMedidor/Lectura'
                   ) AS L(N)
        )
        , ValoresAnteriores AS (
            SELECT
                  X.NumeroMedidor
                , (
                    SELECT TOP 1 LM.SaldoNuevo
                    FROM dbo.LecturasMedidor AS LM
                    WHERE (LM.NumeroMedidor = X.NumeroMedidor)
                    ORDER BY LM.SaldoNuevo DESC
                  ) AS SaldoAnterior
            FROM XMLLecturas AS X
        )
        ...
        SELECT
            ...
            , X.idTipoMovimiento
            , X.Valor
            , ISNULL(VA.SaldoAnterior, 0.0)
            , X.Valor
        FROM XMLLecturas AS X
        LEFT JOIN ValoresAnteriores AS VA
            ON (VA.NumeroMedidor = X.NumeroMedidor);


        -- Actualización del SaldoM3 de la Propiedad
        UPDATE dbo.Propiedad SET
            SaldoM3 = T.Valor
        FROM dbo.Propiedad AS P
        INNER JOIN dbo.Medidor AS M
            ON (M.NumeroFinca = P.NumeroFinca)
        INNER JOIN (
            SELECT
                  N.value('@numeroMedidor', 'VARCHAR(64)') AS NumeroMedidor
                , N.value('@valor', 'FLOAT') AS Valor
            FROM @XmlData.nodes(
                   '/Operaciones/FechaOperacion[@fecha=sql:variable("@Fecha")]/LecturasMedidor/Lectura'
                 ) AS T(N)
        ) AS T
            ON (T.NumeroMedidor = M.NumeroMedidor);

        ------------------------------------------------------------
        -- PROCESAR FACTURAS Y ÓRDENES DE CORTE (Solo el día 1)
        ------------------------------------------------------------

        -- 1. Generar Facturas del Mes
        EXEC dbo.sp_GenerarFacturas_Completo
                @inFecha         = @Fecha
            ,   @inDiasVencimiento = @diasVencimientoFactura
            , @outResultCode = @outFactura OUTPUT;

        IF (@outFactura <> 0)
        BEGIN
            PRINT 'Error generando facturas del día ' + CAST(@Fecha AS VARCHAR(10)) + '. Código: ' + CAST(@outFactura AS VARCHAR(10));
        END
        ELSE
        BEGIN
            PRINT 'Facturas generadas con éxito para el mes de ' + DATENAME(MONTH, @Fecha) + '.';

            -- 2. Generar Órdenes de Corte (Aplica a moras de meses anteriores)
            EXEC dbo.sp_GenerarOrdenesCorteAgua
                    @inFechaCorte  = @Fecha
                , @outResultCode = @outCorte OUTPUT;

            IF (@outCorte <> 0)
            BEGIN
                PRINT 'Advertencia: Error generando órdenes de corte. Código: ' + CAST(@outCorte AS VARCHAR(10));
            END
            ELSE
            BEGIN
                PRINT 'Órdenes de corte verificadas y generadas para facturas vencidas.';
            END
        END
        ...
        SELECT
              PG.N.value('@numeroFinca', 'VARCHAR(64)')
            , PG.N.value('@tipoMedioPagoId', 'INT')
            , PG.N.value('@numeroReferencia', 'VARCHAR(64)')
        FROM @XmlData.nodes(
                 '/Operaciones/FechaOperacion[@fecha=sql:variable("@Fecha")]/Pagos/Pago'
               ) AS PG(N);
        ...
        -- Limpiar la tabla variable al inicio de cada iteración para evitar la violación de PRIMARY KEY
        DELETE FROM @PagosAProcesar;

        WITH PagosXML AS (
            SELECT
                  ROW_NUMBER() OVER (ORDER BY PG.N.value('@numeroFinca', 'VARCHAR(64)')) AS RowID
                , PG.N.value('@numeroFinca', 'VARCHAR(64)') AS NumeroFinca
                , PG.N.value('@tipoMedioPagoId', 'INT') AS idTipoMedioPago
            FROM @XmlData.nodes(
                    '/Operaciones/FechaOperacion[@fecha=sql:variable("@Fecha")]/Pagos/Pago'
                   ) AS PG(N)
        )
        -- Cargar los pagos del día en la tabla variable para la iteración
        INSERT INTO @PagosAProcesar
        (
              RowID
            , NumeroFinca
            , idTipoMedioPago
        ...
        WHILE ( EXISTS(SELECT 1 FROM @PagosAProcesar WHERE (RowID = @RowID)) )
        BEGIN
            -- 1. Obtener datos del pago del XML
            SELECT
                  @NumFincaPago        = NumeroFinca
                , @IdMedioPago         = idTipoMedioPago
            FROM @PagosAProcesar
            WHERE (RowID = @RowID);

            SET @NumComprobantePago = NULL;
            SET @MontoRecibidoPago = NULL;

            -- 2. LLAMAR SP para buscar la factura pendiente más vieja 
            PRINT '    - Buscando y actualizando intereses para Finca ' + @NumFincaPago + '...';
            EXEC dbo.SP_BuscarFacturaPendiente
                  @inNumeroFinca = @NumFincaPago
                , @outResultCode = @outPagoResultCode OUTPUT;

            -- 3. RECUPERAR DATOS ACTUALIZADOS DE LA FACTURA
            SELECT TOP 1
                  @NumComprobantePago = T1.NumeroComprobante
                , @MontoRecibidoPago  = T1.TotalAPagarFinal -- Este es el monto a pagar (incluye intereses)
            FROM dbo.Factura AS T1
            WHERE (T1.NumeroFinca = @NumFincaPago)
              AND (T1.Estado = 'Pendiente')
            ORDER BY T1.FechaVencimiento ASC;

            -- 4. PROCESAR PAGO
            IF (@NumComprobantePago IS NOT NULL)
            BEGIN
                -- Llamada al Stored Procedure de Procesamiento
                EXEC dbo.SP_ProcesarPago
                      @inNumeroComprobante       = @NumComprobantePago
                    , @inNumeroFinca             = @NumFincaPago
                    , @inMontoRecibido           = @MontoRecibidoPago
                    , @inIdTipoMedioPago         = @IdMedioPago
                    , @inFechaOperacion          = @Fecha
                    , @outSuccess                = @outSuccess OUTPUT
                    , @outMessage                = @outMessage OUTPUT
                    , @outMontoFinalPagado       = @outMontoPagado OUTPUT
                    , @outCodigoComprobante      = @outComprobanteCode OUTPUT
                    , @outResultCode             = @outPagoResultCode OUTPUT;

                -- Reporte de la operación
                IF (@outSuccess = 1)
                BEGIN
                    PRINT '    - Pago procesado con éxito. Comprobante ' + CAST(@NumComprobantePago AS VARCHAR) + '. Monto: ' + CAST(@outMontoPagado AS VARCHAR) + '. Comprobante: ' + @outComprobanteCode;
                END
                ELSE
                BEGIN
                    PRINT '    - ERROR al procesar pago. Comprobante ' + CAST(@NumComprobantePago AS VARCHAR) + '. Código: ' + CAST(@outPagoResultCode AS VARCHAR) + '. Mensaje: ' + @outMessage;
                END
            END
            ELSE
            BEGIN
                PRINT '    - ADVERTENCIA: No se encontró factura pendiente para Finca ' + @NumFincaPago + '. Pago omitido.';
            END
