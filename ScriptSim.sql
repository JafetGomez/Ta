...
------------------------------------------------------------
-- CREACIÓN TABLA TEMPORAL #Fechas
------------------------------------------------------------
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
              L.N.value('@numeroMedidor', 'VARCHAR(64)')
            , L.N.value('@tipoMovimientoId', 'INT')
            , L.N.value('@valor', 'FLOAT')
        FROM @XmlData.nodes(
...
END;  -- FIN WHILE
 ...
 ------------------------------------------------------------
    -- Tablas con la informacion ya cargada
------------------------------------------------------------
SELECT * FROM [dbo].[Persona];
SELECT * FROM [dbo].[Propiedad];
SELECT * FROM [dbo].[Medidor];
SELECT * FROM [dbo].[PropiedadPersona];
SELECT * FROM [dbo].[CCPropiedad];
SELECT * FROM [dbo].[LecturasMedidor];
